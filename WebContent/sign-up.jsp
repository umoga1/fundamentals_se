...
<head>
    ...
    <title>Sign Up | Fundamentals of Software Engineering Project</title>
    <!-- Favicon-->
            ...
            <div class="body">
                <form action="Register" method="POST">
                    ...
                    <div class="input-group">
                        ...
                        <div class="form-line">
                            <input type="password" class="form-control" name="retype_password" minlength="6" placeholder="Confirm Password" required>
                        </div>
                    </div>
