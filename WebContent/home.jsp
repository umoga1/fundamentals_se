...
<head>
    ...
    <title>Welcome To Fundamentals of SE | <%= username %></title>
    <!-- Favicon-->
...
<body class="theme-red">
    ...
    <nav class="navbar">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.html">FUNDAMENTALS OF SE | CPSC 5373</a>
            </div>
    ...
    <section>
        ...
        <aside id="leftsidebar" class="sidebar">
            ...
            <div class="user-info">
                <div class="image">
                    <img src="material/images/user.png" width="48" height="48" alt="User" />
                </div>
                <div class="info-container">
                    ...
                    <div class="btn-group user-helper-dropdown">
                        ...
                        <ul class="dropdown-menu pull-right">
                            ...
                            <li role="separator" class="divider"></li>
                            <li><a href="processors/logout.jsp"><i class="material-icons">input</i>Sign Out</a></li>
                        </ul>
                    </div>
                </div>
            </div>
